      ...
      <el-col :xs="24" :sm="24" :lg="16">
        <div class="chart-wrapper left">
          ...
          <el-table :data="recordList" style="width: 100%">
            ...
            <el-table-column prop="createBy" align="center" label="库管员" width="110"></el-table-column>
          </el-table>
        </div>
      </el-col>
      <el-col :xs="24" :sm="24" :lg="8">
...
import ScanGroup from './dashboard/ScanGroup'
...
export default {
  name: 'Index',
  components: { PanelGroup, LineChart, RaddarChart, PieChart, BarChart,ScanGroup },
  data() {
    return {
      today: new Date(),
      logininforList: [],
