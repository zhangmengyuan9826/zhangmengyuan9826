...
<p>货位库存流程：货位单【LOCATION】</p>
 <div v-if="ifscan"> 
    ...
    <!-- <el-button type="primary" @click="confirm" :customStyle="'width:120px;height:64px;margin-left:10px;'">提交</el-button> -->
		<div class="detail">
			<div v-for="(item, index) in matList" :key="index">
				<div :class="[index === selectIndex ? 'detail-item active' : 'detail-item']" @click="chooseItem(item)">
...
import { getInfoM  } from "@/api/stock/info";
...
export default {
 ...
 created(){
// this.onDecode("LOCATION:A01:1001")
      },
  methods: {
      onDecode(result) {
          // alert(result)
